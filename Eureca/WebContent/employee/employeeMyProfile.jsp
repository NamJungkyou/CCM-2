			...
			<section class="wrapper">
				<form name="frm" method="post" enctype="multipart/form-data">
					<section class="panel">
						...
						<table class="table table-bordered">
							<tr>
								...
								<td><input type="password" name="empPw"
									value="${employee.empPw}"></td>
								<th>비밀번호 확인</th>
								<td><input type="password" name="empPw2"
									value="${employee.empPw}"></td>
							</tr>

							<tr>
								<td rowspan="4"><input type="file" name="empPicture"
									value="${employee.empPicture}"> <img
									src="/Eureca/upload/${employee.empPicture}"></td>
								<th>이름</th>
							...
							<tr>
								...
								<td><input type="text" class="datepicker"
									name="empJoinDate" value="${employee.empJoinDate}"></td>
								<th>퇴사일</th>
								<td><input type="text" class="datepicker"
									name="empDropDate" value="${employee.empDropDate}"></td>
								<th>권한</th>
							...
							<tr>
								...
								<td colspan="2"><input type="text" id="roadAddrPart1"
									name="empFrontAddr" value="${employee.empFrontAddr}" size="20"
									style="width: 97%;"></td>
						...
						<input type="button" value="수정" onclick="return MyProfileUpdate()">
					</section>
				</form>
