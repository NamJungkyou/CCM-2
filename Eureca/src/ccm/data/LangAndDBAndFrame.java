...
public class LangAndDBAndFrame
{
	...
	public ArrayList<DBMS> getDbms() { return dbms; }
	public void setDbms(ArrayList<DBMS> dbms) { this.dbms = dbms; }
	public ArrayList<Framework> getFrame() { return frame; }
	public void setFrame(ArrayList<Framework> frame) { this.frame = frame; }
	public ArrayList<ProgLang> getLang() { return lang; }
	public void setLang(ArrayList<ProgLang> lang) { this.lang = lang; }
}
